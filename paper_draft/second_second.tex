...
Our Physics-Aware ANN achieves superior precision (96.59\%) compared to existing benchmarks, which is critical for reducing false alarms in operational settings. While the recall is slightly lower than some reported values, the significantly higher precision demonstrates the benefit of incorporating physical constraints, ensuring that leak predictions are hydraulically consistent and reducing unnecessary operational interventions.
